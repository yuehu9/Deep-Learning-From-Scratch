...
class linear_layer(object):
    ...
    implement z = WX + b
    '''
    def __init__(self, in_dim, out_dim, step_size = 0.1, l2_reg = 0, momentum = False, beta = 0.9):
        '''
        ...
        momentum - whether to use momentum when updating parameters\
        ...
        if self.momentum:
            self.beta = beta
            # velocity for DGD with momentum 
            self.vW = 0
            self.vb = 0
    ...
    def update(self):
        if not self.momentum:
            ...
            self.W -= self.step * self.vW
            self.b -= self.step * self.vb
...
class logistic_regression_head(object):
    ...
    '''
    def __init__(self, in_dim, step_size, l2_reg = 0, momentum = False, beta = 0.9):
        ## random initiate parameters, sample from normal disrtibution
        self.step = step_size
